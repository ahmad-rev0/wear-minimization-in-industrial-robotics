"""
ROBOTWIN Backend — FastAPI application entry point.
...
async def lifespan(app: FastAPI):
    ...
    log.info("ROBOTWIN backend starting — upload dir: %s", UPLOAD_DIR)
    yield
    log.info("ROBOTWIN backend shutting down")
...
@app.get("/health")
def health_check():
    return {"status": "ok", "service": "robotwin"}
